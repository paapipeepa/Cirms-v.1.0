...
qq.FileUploaderBasic.prototype = {
    ...
    _validateFile: function(file, files){
        ...
        } else if(this._options.fileLimit > 0 && (this._element.select('.qq-upload-list').length > 0 && this._element.select('.qq-upload-list')[0].select('li').length + files.length > this._options.fileLimit)) {
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button {buttonStyle}">' + this._options.buttonText + '</div>' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        JotForm.runConditionForId(item.up('.form-line').id.split('id_')[1]);
